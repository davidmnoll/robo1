...
![Demo](./docs/scrncst1.gif)        

Purpose: 
---

The main goal of this project is to allow a multi-player lobby to control a robot or robots within an arena. 
...
Part of the goal is to allow and explore "Malkovich mode" where multiple users can jointly control the robot while in a voice lobby, allowing joint control.  One feature that has been implemented along these lines is that when multiple people are in the lobby, all must approve for the voice chat audio to be routed to the robot speaker.  
